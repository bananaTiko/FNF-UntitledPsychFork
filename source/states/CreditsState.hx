...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			["Untitled Psych Fork Creator"],
			['bananaTiko',			'tiko',		"Creator and Programmer for Untitled Psych Fork",				 'https://twitter.com/Banana_tiko_2',					'ffc127'],
			[""],
			["Special Thanks"],
			['crowplexus',			'crowplexus',		"Prepare intro sprites",				 'https://twitter.com/IamMorwen',		'CFCFCF'],
			['Cobalt', 'cobalt', 'Creator  of Horizon Engine', 'https://github.com/CCobaltDev', '002A56'],
			['mikolka9144',			'mikolka', 		'Creator of P-Slice, Erect stages',				 'https://gamebanana.com/members/3329541',		'2ebcfa'],
			['Moonlight_Catalyst',			'moonlight_catalyst', 		'Creator of Moons Modded Psych',				 'https://www.youtube.com/channel/UCmvsORFe7ZldiG4budmzELA',		'9764B7'],
			['chromasen', 'chromasen', 'Code for the Windows Notification Event  (JS ENGINE)', 'https://www.youtube.com/channel/UCgGk4oZt3We-ktkEOV9HY1Q', 'FFFFFF'],
			['Erizur', 'erizur', 'Cross-Platform code for the Windows Notification Event (JS ENGINE)', 'https://www.youtube.com/channel/UCdCAaQzt9yOGfFM0gJDJ4bQ', 'FFFFFF'],
