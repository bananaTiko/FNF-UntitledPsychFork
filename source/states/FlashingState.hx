...
class FlashingState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var warnText:FlxText = new FlxText(0, 0, FlxG.width,
			"Hey, watch out!\n
			Untitled Psych Fork and its content may include flashing lights.\n 
			Rapid flashing lights can trigger seizures or other health issues in people with photosensitivity.\n
			These effects may also cause discomfort or dizziness for some users.\n
			If you are unsure, we recommend disabling these effects for your safety.\n
