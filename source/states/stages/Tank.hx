...
class Tank extends BaseStage
{
	...
	function ughIntro()
	{
		...
		Paths.sound('wellWellWell-' + ClientPrefs.data.language);
		Paths.sound('killYou');
		Paths.sound('killYou-' + ClientPrefs.data.language);
		Paths.sound('bfBeep');

		var wellWellWell:FlxSound = new FlxSound().loadEmbedded(Paths.sound('wellWellWell'));
		FlxG.sound.list.add(wellWellWell);
		var wellWellWell2:FlxSound = new FlxSound().loadEmbedded(Paths.sound('wellWellWell-' + ClientPrefs.data.language));
		FlxG.sound.list.add(wellWellWell2);
		var killYou:FlxSound = new FlxSound().loadEmbedded(Paths.sound('killYou'));
		FlxG.sound.list.add(killYou);
		var killYou2:FlxSound = new FlxSound().loadEmbedded(Paths.sound('killYou-' + ClientPrefs.data.language));
		FlxG.sound.list.add(killYou2);
		...
		{
			if (ClientPrefs.data.language == 'en-US') {
				wellWellWell.play(true);
				audioPlaying = wellWellWell;
			} else if (ClientPrefs.data.language == ClientPrefs.data.language) { //Might not be the best way of doing this but it works LMAO - bananaTiko
				wellWellWell2.play(true);
				audioPlaying = wellWellWell2;
			}
		});
		...
		cutsceneHandler.timer(6, function()
		{
			...
			} else if (ClientPrefs.data.language == ClientPrefs.data.language) {
				killYou2.play(true);
				audioPlaying = killYou2;
			}
		});
	}
	function gunsIntro()
	{
		...
		Paths.sound('tankSong2-pt-BR');

		var tightBars:FlxSound = new FlxSound().loadEmbedded(Paths.sound('tankSong2'));
		FlxG.sound.list.add(tightBars);
		var tightBars2:FlxSound = new FlxSound().loadEmbedded(Paths.sound('tankSong2-pt-BR'));
		FlxG.sound.list.add(tightBars2);
		...
		cutsceneHandler.onStart = function()
			{
				if (ClientPrefs.data.language == 'en-US') {
					...
					tightBars2.play(true);
					audioPlaying = tightBars2;
				}
	...
	function stressIntro()
	{
		...
		Paths.sound('stressCutscene-pt-PR');
		...
		var cutsceneSnd2:FlxSound = new FlxSound().loadEmbedded(Paths.sound('stressCutscene-'+ ClientPrefs.data.language));
		FlxG.sound.list.add(cutsceneSnd2);
		...
		cutsceneHandler.onStart = function()
		{
			if (ClientPrefs.data.language == 'en-US') {
				...
				cutsceneSnd2.play(true);
				audioPlaying = cutsceneSnd2;
			}
		};
