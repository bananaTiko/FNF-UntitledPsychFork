...
class ABotSpeakerFunctions extends BaseStage {
    ...
    function transitionState()
        ...
        if(abot == null || abot.darkSpeaker == null) return;
        abot.darkSpeaker.alpha = 1;
        abot.speaker.alpha = 0;
        FlxTween.tween(abot.darkSpeaker,{alpha:0},1.5,{
            ease: FlxEase.linear
        });
