...
class VisualsSettingsSubState extends BaseOptionsMenu
{
	...
	public function new()
	{
		...
		#if windows
		var option:Option = new Option(Language.getPhrase('setting_title_bar','Title Bar Color:'),
...
function onChangeWindowBar() {
    if (ClientPrefs.data.daWindowBar == 'Light') {
        WindowColorMode.setLightMode();
        WindowColorMode.redrawWindowHeader();
    } else if (ClientPrefs.data.daWindowBar == 'Dark') {
