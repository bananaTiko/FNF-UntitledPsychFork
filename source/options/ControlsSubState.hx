...
class ControlsSubState extends MusicBeatSubstate
{
	...
	public function new()
	{
		...
		#if DISCORD_ALLOWED
		DiscordClient.changePresence("Changing Controls", null);
		#end
	...
	/*function nintendoCheck(alpha:Alphabet) // Used to Set Up FPS Plus Switch Pro controller Icons
		{
			if(onKeyboardMode) return;
	...
	function xboxCheck(alpha:Alphabet) //Used to Set Up FPS Plus xbox controller Icons
		{
			if(onKeyboardMode) return;
