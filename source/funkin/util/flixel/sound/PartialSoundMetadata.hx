...
class PartialSoundMetadata
{
  ...
  {
    if (PartialSoundMetadata._instance == null) set_instance(new PartialSoundMetadata());
    if (PartialSoundMetadata._instance == null) throw "Error: Could not instantiate PartialSoundMetadata";
