...
class Achievements {
	public static function init()
	{
		...
		createAchievement('spooky_month',		{name: "It's a spooky month", description: "Play during the month of October", hidden: true});
		createAchievement('spooky_before_christmas',		{name: "It's Not Spooky Month", description: "Play during the months of December or November", hidden: true});
