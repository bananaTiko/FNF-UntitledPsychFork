...
class DiscordClient
{
	...
	private inline static final _defaultID:String = "1293798293377253462";
	...
	public static function changePresence(details:String = 'In the Menus', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'icon')
	{
		...
		presence.largeImageText = "Engine Version: " + states.MainMenuState.untitledPsychForkVersion + " (Psych " + states.MainMenuState.psychEngineVersion + ")";
