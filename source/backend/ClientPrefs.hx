...
@:structInit class SaveVariables {
	...
	public var daWindowBar:String = 'Light';
	...
	public var oppHitsoundType:String = 'Default';
	public var hitsoundVolume:Float = 0;
	public var opphitsoundVolume:Float = 0;
	...
	public var epicWindow:Float = 15.0;
	...
	public var daColorFilter:String = "NONE";
	#if Mobile
...
class ClientPrefs {
	...
	function onChangeWindowBar() {
		if (data.daWindowBar == 'Light') {
			WindowColorMode.setLightMode();
			WindowColorMode.redrawWindowHeader();
		} else if (data.daWindowBar == 'Dark') {
